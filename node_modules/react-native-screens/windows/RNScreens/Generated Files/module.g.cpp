...
void* winrt_make_RNScreens_RNScreensModule();
void* winrt_make_RNScreens_ReactPackageProvider();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"RNScreens.RNScreensModule"))
    {
        return winrt_make_RNScreens_RNScreensModule();
    }

    if (requal(name, L"RNScreens.ReactPackageProvider"))
    {
        return winrt_make_RNScreens_ReactPackageProvider();
    }
