...
void* winrt_make_caliper_MainPage();
void* winrt_make_caliper_XamlMetaDataProvider();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"caliper.MainPage"))
    {
        return winrt_make_caliper_MainPage();
    }

    if (requal(name, L"caliper.XamlMetaDataProvider"))
    {
        return winrt_make_caliper_XamlMetaDataProvider();
    }
